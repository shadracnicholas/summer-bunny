    ...
    <div className="h-screen flex overflow-hidden bg-gray-100">
            ...
            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-pink-700">
              ...
              <div className="flex-shrink-0 flex items-center px-4">
                <img
                  ...
                  src="/logo.png"
                  alt="Summer Bunny Logo"
                />
              </div>
              <nav className="mt-5 flex-shrink-0 h-full divide-y divide-pink-800 overflow-y-auto" aria-label="Sidebar">
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current ? 'bg-pink-800 text-white' : 'text-pink-100 hover:text-white hover:bg-pink-600',
                        'group flex items-center px-2 py-2 text-base font-medium rounded-md'
                      )}
                      aria-current={item.current ? 'page' : undefined}
                    >
                      <item.icon className="mr-4 h-6 w-6 text-pink-200" aria-hidden="true" />
                      {item.name}
                    </a>
                  ))}
                </div>
                  ...
                  <div className="px-2 space-y-1">
                    {secondaryNavigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="group flex items-center px-2 py-2 text-base font-medium rounded-md text-pink-100 hover:text-white hover:bg-pink-600"
                      >
                        <item.icon className="mr-4 h-6 w-6 text-pink-200" aria-hidden="true" />
                        {item.name}
                      </a>
      ...
      <div className="hidden lg:flex lg:flex-shrink-0">
        <div className="flex flex-col w-64">
          ...
          <div className="flex flex-col flex-grow bg-pink-700 pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 flex flex-col divide-y divide-pink-800 overflow-y-auto" aria-label="Sidebar">
              <div className="px-2 space-y-1">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                ...
                <div className="px-2 space-y-1">
                  {secondaryNavigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-pink-100 hover:text-white hover:bg-pink-600"
                    >
                      <item.icon className="mr-4 h-6 w-6 text-pink-200" aria-hidden="true" />
                      {item.name}
                    </a>
      ...
      <div className="flex-1 overflow-auto focus:outline-none">
        <div className="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none">
          <button
            className="px-4 border-r border-gray-200 text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-pink-500 lg:hidden"
            ...
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <Menu as="div" className="ml-3 relative">
                {({ open }) => (
                  <>
                    <div>
                      <Menu.Button className="max-w-xs bg-white rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 lg:p-2 lg:rounded-md lg:hover:bg-gray-50">
                        <img
